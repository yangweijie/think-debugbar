 ...
 */
class SqlCollector extends PDOCollector
{
    ...
    protected $backtraceExcludePaths = [
        '/vendor/topthink/framework/src/think/Db',
...
//        }
    ...
    public function addQuery($query)
    {
        ...
        $explainResults = [];
//        dump(Reflection::classProperties($query->getConnection(), 'queryStartTime'));
...
//        $time = Reflection::classProperties($query->getConnection(), 'queryStartTime')?:0;
        ...
        $bindings = Reflection::classProperties($query, 'bind')??[];
        ...
        $this->queries[] = [
            ...
            'start' => $query->getConnection()->queryStartTime,
            'time' =>  $startTime,
            'memory' => $this->lastMemoryUsage ? memory_get_usage(false) - $this->lastMemoryUsage : 0,
            'source' => $source,
            'explain' => $explainResults,
            'connection' => $query->getConnection()->getConfig('database'),
    ...
    protected function parseTrace($index, array $trace)
    {
        ...
        if (
            ...
            } elseif (strpos($frame->file, runtime_path()) !== false) {
